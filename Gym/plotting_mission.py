...
import numpy as np
import random
'''import matplotlib #per il docker
...
class Plot:
    ...
    def RGBA_01_random_colors(self, num_colors):
        ...
        for color_idx in num_color_range:
            colors[color_idx] = (
            random.randint(0, 255) / 255, random.randint(0, 255) / 255, random.randint(0, 255) / 255, 1.0)
    ...
    def plt_map_views(self, obs_points=None, cs_points=None, enb_point=None, hosp_points=None,
        ...
        DARK_GREEN_square = mlines.Line2D([], [], color=DARK_GREEN, marker='s', markersize=15,
                                          label="'Point' Charging Stations")
        LIGHT_GREEN_square = mlines.Line2D([], [], color=LIGHT_GREEN, marker='s', markersize=15,
                                           label="'Cell' Charging Stations")
        ...
        HOSP_CIRCLES = [
            mlines.Line2D([], [], color=HOSP_PRIORITIES[i], marker='o', markersize=15, label="Goal 2 " ) if i % 2 == 0 else mlines.Line2D([], [], color=HOSP_PRIORITIES[i], marker='o', markersize=15, label="Goal 1 " )
            for i in range(1, N_HOSP_TOT + 1)]
        ...
        if path_animation == True:
            ...
            if (HOSP_SCENARIO == False):
                ...
                users_x_for_2DplotCells, users_y_for_2DplotCells = [float(x) - 0.5 for x in users_x], [float(y) - 0.5
                                                                                                       for y in users_y]
                users_x_for_3DplotCells, users_y_for_3DplotCells, users_z_for_3DplotCells = [x for x in users_x], [y for
                                                                                                                   y in
                                                                                                                   users_y], users_z
            ...
            if (DIMENSION_2D == False):
                ...
                for path in data_path:
                    ...
                    circles.append(plt.Circle(xy=(path[0, 0:1], path[1, 0:1]), radius=ACTUAL_UAV_FOOTPRINT,
                                              color=UAVS_COLORS[uav_color_count], fill=True, alpha=0.00)) #per attivare 0.35
                    uav_color_count += 1
            ...
            if (DIMENSION_2D == False):
                ...
                ani = animation.FuncAnimation(fig, self.update_animation_3D, frames=animation_frames,
                                              ...
                                              blit=True, repeat=True)  # fargs=(data_path, lines, circles)
            else:
                ani = animation.FuncAnimation(fig, self.update_animation_2D, frames=animation_frames,
                                              fargs=(data_path, lines, circles), interval=100, blit=True, repeat=False)
            ...
            if ((where_to_save != None) and (episode != None)):
                ...
                ani.save(join(where_to_save, "animation_scenario" + str(episode) + ".gif"), writer='imagemagick')
                plt.close(fig)
            else:
                plt.show()
        ...
        # ______________________________________________________________ FIGURES FOR STATIC ENVIRNONMENT VISUALIZATION (WITHOUT UAVS): ______________________________________________________________
            ...
            ax1.imshow(points_status_matrix,
                       cmap=cmap1)  # Here the transpose is used because the first argument of 'imshow' take (M,N) where 'M' are the rows and 'N' are the columns (while we store them in the form (x,y) where 'x' are the columns and 'y' are the rows)
                ...
                if (HOSP_SCENARIO == False):
                    ...
                    for cluster_idx in self.num_color_range:
                        patch = plt.Circle([centroids[cluster_idx][1] + incr_assumed_coord,
                                            centroids[cluster_idx][0] + incr_assumed_coord, centroids[cluster_idx][2]],
                                           float(clusters_radiuses[cluster_idx]),
                                           color=self.clusters_colors[cluster_idx], fill=False)
                        ax2.add_patch(patch)
                        art3d.pathpatch_2d_to_3d(patch)
            ...
            if ((area_height != N_cells_row) and (area_width != N_cells_col)):
                ...
                if (DIMENSION_2D == False):
                    if (HOSP_SCENARIO == False):
                        ...
                        for cluster_idx in self.num_color_range:
                            patch = plt.Circle([centroids[cluster_idx][1] + incr_assumed_coord,
                                                centroids[cluster_idx][0] + incr_assumed_coord,
                                                centroids[cluster_idx][2]], float(clusters_radiuses[cluster_idx]),
                                               color=self.clusters_colors[cluster_idx], fill=False)
                            ax6.add_patch(patch)
                            art3d.pathpatch_2d_to_3d(patch)
    ...
    def bandwidth_for_each_epoch(self, epochs, directory_name, UAVs_used_bandwidth,
...
if __name__ == '__main__':
    ...
